...
public class MoneyUtil {
    ...
    public static String toChinese(String str) {
        ...
        if (!Util.isStringNull(str) && BigDecimalUtil.isEqual("0", str)) {
            return "零元";
        }
    ...
    public static boolean isAmtEqChn(String amount, String chineseAmount) {
        ...
        if (TextUtils.isEmpty(chineseAmount)) {
            return false;
        }
     ...
     * 格式化金额
     *
     * @return 123, 321, 211.23 元
     */
    public static String formatAmount(Object amount) {
        return formatAmountNoYuan(amount) + "元";
    }

    /**
     * 格式化金额
     *
     * @return 123, 321, 211.23
     */
    public static String formatAmountNoYuan(Object amount) {
    ...
    public static String formatNum(Object num) {
        if (num == null || Util.isStringNull(num + ""))
            return "0.00";
        else {
