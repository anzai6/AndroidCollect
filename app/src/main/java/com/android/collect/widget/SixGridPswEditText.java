...
/**
 * 自定义六格支付密码输入框
 * @author https://github.com/lygttpod/AndroidCustomView
 */
public class SixGridPswEditText extends EditText {
    ...
    public SixGridPswEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    private void getAtt(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.SixGridPswEditText);
        maxCount = typedArray.getInt(R.styleable.SixGridPswEditText_maxCount, maxCount);
        circleColor = typedArray.getColor(R.styleable.SixGridPswEditText_circleColor, circleColor);
        bottomLineColor = typedArray.getColor(R.styleable.SixGridPswEditText_bottomLineColor, bottomLineColor);
        radius = typedArray.getDimensionPixelOffset(R.styleable.SixGridPswEditText_radius, radius);

        divideLineWidth = typedArray.getDimensionPixelSize(R.styleable.SixGridPswEditText_divideLineWidth, divideLineWidth);
        divideLineColor = typedArray.getColor(R.styleable.SixGridPswEditText_divideLineColor, divideLineColor);
        psdType = typedArray.getInt(R.styleable.SixGridPswEditText_psdType, psdType);
        rectAngle = typedArray.getDimensionPixelOffset(R.styleable.SixGridPswEditText_rectAngle, rectAngle);
        focusedColor = typedArray.getColor(R.styleable.SixGridPswEditText_focusedColor, focusedColor);
