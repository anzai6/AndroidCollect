package com.android.collect.widget.circleprogress;
...
import com.android.collect.library.util.MoneyUtil;
 ...
 *
 * @author https://github.com/MyLifeMyTravel/CircleProgress
 */
public class CircleProgress extends View {
    ...
    private void drawText(Canvas canvas) {
        ...
        String a = String.format(mPrecisionFormat, mValue);
        String text = Util.isStringNull(strValue) ? MoneyUtil.formatAmountNoYuan(mValue + "") : MoneyUtil.formatAmountNoYuan(strValue);
        canvas.drawText(text, mCenterPoint.x, mValueOffset + DpPxUtils.dip2px(mContext, 16), mValuePaint);
    ...
    private void setValue(float value) {
        ...
        startAnimator(start, end, mAnimTime, value);
    }
    ...
    private void startAnimator(float start, float end, long animTime, final float value) {
...
//                mValue = mPercent * mMaxValue;
     ...
     */
    public void reset() {
        startAnimator(mPercent, 0.0f, 1000L, 0);
    }
